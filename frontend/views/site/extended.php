    ...
    <div class="container">
      <div class="ability--item">
        <div class="ability--descrip">
          <div class="ability--icon"><img src="/img/browser-lock-icon.svg" alt=""/></div>
          <div>
      ...
      <div class="ability--item">
        <div class="ability--descrip">
          <div class="ability--icon"><img src="/img/teamwork-icon.svg" alt=""/></div>
          <div>
      ...
      <div class="ability--item">
        <div class="ability--descrip">
          <div class="ability--icon"><img src="/img/organization-icon.svg" alt=""/></div>
          <div>
      ...
      <div class="ability--item">
        <div class="ability--descrip">
          <div class="ability--icon"><img src="/img/loader-icon.svg" alt=""/></div>
          <div>
